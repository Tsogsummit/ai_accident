...
class ApiConfig {
  ...
  static const String localIP = '192.168.0.104'; // ЭНИЙГ ӨӨРЧИЛ!
  ...
  static const int reportPort = 3007; // ✅ REPORT SERVICE PORT
  ...
  static String get videoServiceUrl =>
      'http://$localIP:$videoPort'; // ✅ VIDEO URL
  ...
  static String get reportServiceUrl =>
      'http://$localIP:$reportPort'; // ✅ REPORT SERVICE URL
  ...
  static String get videoStatusEndpoint =>
      '$videoServiceUrl/videos'; // /videos/:id/status
